configuration DSC_Admt_HybridWorker
{
    ...
    Node $AllNodes.Where{$_.Role -eq 'Member'}.NodeName
    {
        ...
        xPackage Access2016Engine {
            Ensure = 'Present'
            Name = 'AccessDatabaseEngine_X64'
            Path = '\\srv.aau.dk\Fileshares\dsc-install\AccessDatabaseEngine\AccessDatabaseEngine_X64.exe'
            ProductId = '{90160000-00D1-0409-1000-0000000FF1CE}'
            Credential = $cred
        }
    }
}